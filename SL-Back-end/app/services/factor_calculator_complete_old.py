...
class CompleteFactorCalculator:
    ...
    def _build_factor_frame(
        ...
        momentum_series = momentum_window.groupby('stock_code').apply(
        ...
        merged = merged.merge(momentum_series, left_on='stock_code', right_index=True, how='left')
